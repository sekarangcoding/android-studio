        ...
        public ViewHolder(View itemView) {
            ...
            txtjudul.setOnClickListener( new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(context, Jurnal_Detail.class);
                    ...
                    intent.putExtra("issn", list_data.get(pos).get("issn"));
                    intent.putExtra("file_jurnal", list_data.get(pos).get("file_jurnal"));
